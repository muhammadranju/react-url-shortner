const Heading = () => {
  return (
    <div className="text-center space-y-3 lg:my-20 my-10 mx-auto">
      <h1 className="text-white/85 font-bold mx-auto text-2xl lg:text-4xl w-full lg:w-[600px] text-center ">
      ...
      <p className="w-full lg:w-[700px] mx-auto font-extralight ">
